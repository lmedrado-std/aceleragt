            ...
            <div className="flex flex-col items-center gap-6 w-full max-w-7xl">
                ...
                <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-3 w-full mt-6">
                    ...
                    <Card className="border-destructive">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-destructive">Ganhos Totais (Prêmios)</CardTitle>
                        <Award className="h-4 w-4 text-destructive" />
                        </CardHeader>
                        <CardContent>
                        <div className="text-2xl font-bold text-destructive">{formatCurrency(totalIncentives)}</div>
                ...
                <div className="grid md:grid-cols-2 gap-6 w-full mt-6">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2"><Award className="text-accent" /> Top 5 Vendedores (Ganhos)</CardTitle>
                                ...
                                <TableBody>
                                    {topSellersByIncentives.map((seller, index) => (
                                        <TableRow key={seller.id}>
                                            ...
                                            <TableCell>{seller.name}</TableCell>
                                            <TableCell className="text-muted-foreground">{seller.storeName}</TableCell>
                                            <TableCell className="text-right font-semibold text-accent">{formatCurrency(seller.totalIncentives)}</TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
                            </Table>
