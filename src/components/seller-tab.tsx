        ...
        <TabsList className="h-auto p-1 bg-muted/30 rounded-xl grid grid-cols-2 sm:grid-cols-6 w-full sm:w-max gap-2">
          <Tooltip>
            <TooltipTrigger asChild>
              <div>
                <TabsTrigger value="desempenho" className={tabTriggerClass}><Trophy className="mr-2 h-4 w-4" />Desempenho</TabsTrigger>
              </div>
            </TooltipTrigger>
            <TooltipContent><p>Ver desempenho e progresso das metas</p></TooltipContent>
          </Tooltip>
          
          <Tooltip>
            <TooltipTrigger asChild>
              <div>
                <TabsTrigger value="lancamentos" className={tabTriggerClass}><BarChart className="mr-2 h-4 w-4" />Lançamentos</TabsTrigger>
              </div>
            </TooltipTrigger>
            <TooltipContent><p>Ver dados lançados pelo administrador</p></TooltipContent>
          </Tooltip>

          <Tooltip>
            <TooltipTrigger asChild>
              <div>
                <TabsTrigger value="corridinhas" className={tabTriggerClass}><Rocket className="mr-2 h-4 w-4" />Corridinhas</TabsTrigger>
              </div>
            </TooltipTrigger>
            <TooltipContent><p>Ver metas e bônus de curto prazo</p></TooltipContent>
          </Tooltip>

          <Tooltip>
            <TooltipTrigger asChild>
              <div>
                <TabsTrigger value="metas" className={tabTriggerClass}><Target className="mr-2 h-4 w-4" />Metas</TabsTrigger>
              </div>
            </TooltipTrigger>
            <TooltipContent><p>Consultar os valores de todas as metas</p></TooltipContent>
          </Tooltip>

          <Tooltip>
            <TooltipTrigger asChild>
              <div>
                <TabsTrigger value="roleta" className={cn(tabTriggerClass, prizeWheelCredits > 0 && "ring-2 ring-destructive/60")}><Gift className="mr-2 h-4 w-4" />Roleta</TabsTrigger>
              </div>
            </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <div>
                <TabsTrigger value="dicas" className={tabTriggerClass}><Lightbulb className="mr-2 h-4 w-4" />Dicas</TabsTrigger>
              </div>
            </TooltipTrigger>
